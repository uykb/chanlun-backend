  ...
  return {
    render_zixuan_opts: function () {
      $.ajax({
        type: "GET",
        url:
          window.API_BASE_URL + "/get_stock_zixuan/" +
          Utils.get_market() +
          "/" +
    ...
    render_zixuan_stocks: function () {
      ...
      layui.use(["table", "dropdown", "util"], function () {
        ...
        table.render({
          ...
          url:
            window.API_BASE_URL + "/get_zixuan_stocks/" + Utils.get_market() + "/" + ZiXuan.zx_group,
          ...
          dropdown.render({
            ...
            click: function (menuData, othis) {
              if (menuData["id"] === "del") {
                $.ajax({
                  type: "POST",
                   url: window.API_BASE_URL + "/set_stock_zixuan",
    ...
    init_zixuan_opts: function () {
      ...
      layui.use(function () {
        ...
        $.ajax({
          type: "GET",
          url: window.API_BASE_URL + "/get_zixuan_groups/" + Utils.get_market(),
          ...
          remoteMethod: function (val, cb, show) {
            if (val) {
              $.ajax({
                type: "GET",
                 url:
                  window.API_BASE_URL + "/tv/search?limit=30&type=&query=" +
                  val +
                  "&exchange=" +
                  Utils.get_market(),
